...
class OrderConfirmationView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe2d96681532'
        ...
        <span className="af-view">
          <div>
            <div className="af-class-page-wrap af-class-no-overflow">
              ...
              <div data-node-type="commerce-order-confirmation-wrapper" data-wf-order-query data-wf-page-link-href-prefix className="w-commerce-commerceorderconfirmationcontainer af-class-checkout-form">
                <div className="w-commerce-commercelayoutcontainer af-class-shipping-container w-container">
                  <div className="w-commerce-commercelayoutmain">
                    ...
                    <div className="w-commerce-commercecheckoutshippingsummarywrapper af-class-checkout-block">
                      <div className="w-commerce-commercecheckoutsummaryblockheader af-class-block-header">
                  ...
                  <div className="w-commerce-commercelayoutsidebar af-class-sticky-form">
                    <div className="w-commerce-commercecheckoutorderitemswrapper af-class-checkout-block">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content">
                        <div className="w-commerce-commercecheckoutorderitemslist" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-5e8303ddedce1955fd3d7dc3000000000051" />
                      </fieldset>
                    </div>
                    <div className="w-commerce-commercecheckoutordersummarywrapper af-class-checkout-block">
                      ...
                      <fieldset className="w-commerce-commercecheckoutblockcontent af-class-block-content">
                        ...
                        <div className="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-5e8303ddedce1955fd3d7dc300000000006b">
