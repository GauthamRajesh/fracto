...
class AboutView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbee265681523'
        ...
        <span className="af-view">
          <div>
            <div style={{opacity: 0}} className="af-class-page-wrap">
                ...
                <div className="af-class-container af-class-nav-container">
                  ...
                  <div className="af-class-nav-right-wrap">
                    <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                      <a href="about.html" aria-current="page" className="af-class-nav-link w-nav-link w--current">Collection</a>
              ...
              <div className="af-class-section af-class-about-hero af-class-wf-section">
                <div className="af-class-container">
                  <div className="af-class-hero-slider-content">
                    <div id="w-node-f2bd7fdc-a738-1450-b4f9-1b53880bc1f6-65681523" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin">Hi i'm Sandra Lyons<br /></div>
                      <h1>Who can benefit from a fully custom online fitness plan &amp; nutrition?</h1>
                    ...
                    <div className="af-class-column af-class-hero-image-column">
                      <div className="af-class-hero-slider-image-wrap"><img src="images/logan-weaver-p3xsJQiu2YA-unsplash.jpg" srcSet="images/logan-weaver-p3xsJQiu2YA-unsplash-p-500.jpeg 500w, images/logan-weaver-p3xsJQiu2YA-unsplash-p-800.jpeg 800w, images/logan-weaver-p3xsJQiu2YA-unsplash-p-1080.jpeg 1080w, images/logan-weaver-p3xsJQiu2YA-unsplash-p-1600.jpeg 1600w, images/logan-weaver-p3xsJQiu2YA-unsplash.jpg 1961w" sizes="(max-width: 767px) 95vw, (max-width: 991px) 46vw, 45vw" alt className="af-class-hero-slider-image" /></div>
                    </div>
                  </div>
                </div>
              </div>
              <div data-w-id="704f228a-8df5-ffa9-c2aa-29c84ad7d262" className="af-class-section af-class-about-s2 af-class-wf-section">
                <div className="af-class-container af-class-video-container">
                  <div id="w-node-_8d350ed8-e9a4-eb03-1dcf-82faec0a87df-65681523" className="af-class-column af-class-feature-headline">
                    <h2 className="af-class-max-800">How does online fitness coaching work ?</h2>
                    <p className="af-class-big-paragraph af-class-max-800 af-class-no-margin">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla.</p>
                  </div>
                  <a href="#" className="af-class-about-video-wrap w-inline-block w-lightbox"><img src="images/logan-weaver-WJUrYr5KqSw-unsplash.jpg" srcSet="images/logan-weaver-WJUrYr5KqSw-unsplash-p-1080.jpeg 1080w, images/logan-weaver-WJUrYr5KqSw-unsplash-p-1600.jpeg 1600w, images/logan-weaver-WJUrYr5KqSw-unsplash-p-2000.jpeg 2000w, images/logan-weaver-WJUrYr5KqSw-unsplash-p-2600.jpeg 2600w, images/logan-weaver-WJUrYr5KqSw-unsplash.jpg 2712w" sizes="95vw" alt className="af-class-about-video-image" />
                    <div className="af-class-play-button-wrap"><img src="images/Play-Button.svg" alt className="af-class-play-button" /></div>
                  </a>
                </div>
              </div>
              <div data-w-id="4cb83808-f988-e8d9-cf74-c6011c7b007b" className="af-class-section af-class-about-section-3 af-class-wf-section">
                <div className="af-class-container af-class-grid-2">
                  <div id="w-node-_48f1e152-304c-af08-bac2-2094cbc0c067-65681523" className="af-class-column af-class-description-heading">
                    <h2 className="af-class-max-600">I am Aaron</h2>
                    <p className="af-class-big-paragraph af-class-max-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <ul role="list">
                      <li>
                        <h5 className="af-class-scribble-text af-class-list-text">01</h5>
                        <div>Over 10 years of experience</div>
                      </li>
                      <li>
                        <h5 className="af-class-scribble-text af-class-list-text">02</h5>
                        <div>Coached 2,000+ people</div>
                      </li>
                      <li>
                        <h5 className="af-class-scribble-text af-class-list-text">03</h5>
                        <div>Bachelors in nutrition</div>
                      </li>
                    </ul>
                    <a href="contact.html" className="af-class-button w-button">Schedule a call</a>
                  </div>
                  <div id="w-node-d7b1a011-026b-afea-5499-7750c3a8ba54-65681523" className="af-class-description-image-wrap"><img src="images/angelos-michalopoulos-S3Rs0DcvvK0-unsplash.jpg" srcSet="images/angelos-michalopoulos-S3Rs0DcvvK0-unsplash-p-500.jpeg 500w, images/angelos-michalopoulos-S3Rs0DcvvK0-unsplash-p-800.jpeg 800w, images/angelos-michalopoulos-S3Rs0DcvvK0-unsplash-p-1080.jpeg 1080w, images/angelos-michalopoulos-S3Rs0DcvvK0-unsplash-p-1600.jpeg 1600w, images/angelos-michalopoulos-S3Rs0DcvvK0-unsplash.jpg 1759w" sizes="(max-width: 767px) 95vw, (max-width: 991px) 42vw, 34vw" alt className="af-class-description-image" /></div>
                </div>
                <div className="af-class-description-bg af-class-about-bg" />
              </div>
              <div data-w-id="a91364e5-4e66-737f-0295-c3796be69e8e" className="af-class-section af-class-about-section-4 af-class-wf-section">
                <div className="af-class-container af-class-grid-2">
                  <div id="w-node-a91364e5-4e66-737f-0295-c3796be69ea5-65681523" className="af-class-description-image-wrap"><img src="images/logan-weaver-DVWa-aq3_m4-unsplash.jpg" srcSet="images/logan-weaver-DVWa-aq3_m4-unsplash-p-500.jpeg 500w, images/logan-weaver-DVWa-aq3_m4-unsplash-p-800.jpeg 800w, images/logan-weaver-DVWa-aq3_m4-unsplash-p-1080.jpeg 1080w, images/logan-weaver-DVWa-aq3_m4-unsplash-p-1600.jpeg 1600w, images/logan-weaver-DVWa-aq3_m4-unsplash.jpg 1769w" sizes="(max-width: 767px) 95vw, (max-width: 991px) 42vw, 34vw" alt className="af-class-description-image" /></div>
                  <div id="w-node-a91364e5-4e66-737f-0295-c3796be69e90-65681523" className="af-class-column af-class-description-heading">
                    <h2 className="af-class-max-600">I am Aaron</h2>
                    <p className="af-class-big-paragraph af-class-max-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <ul role="list">
                      <li>
                    ...
                    <a href="contact.html" className="af-class-button w-button">Explore our shop</a>
                  </div>
                </div>
                <div className="af-class-description-bg af-class-left" />
              </div>
              ...
              <div className="af-class-section af-class-footer-section af-class-wf-section">
                <div className="af-class-container af-class-footer-container">
                  ...
                  <div id="w-node-_1d6466da-e94d-115c-c97d-71e22c54b46f-2c54b452" className="af-class-column">
                    ...
                    <a href="about.html" aria-current="page" className="af-class-footer-link w--current">About</a>
