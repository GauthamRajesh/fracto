...
class IndexView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe4a58681516'
            ...
            <div style={{opacity: 0}} className="af-class-page-wrap">
              <div data-collapse="medium" data-animation="over-right" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navbar w-nav">
                <div className="af-class-container af-class-nav-container">
                  <a href="index.html" aria-current="page" className="af-class-brand w-nav-brand w--current"><img src="images/fracto_logo-removebg-preview.png" width={100} sizes="100px" srcSet="images/fracto_logo-removebg-preview-p-500.png 500w, images/fracto_logo-removebg-preview.png 703w" alt className="af-class-brand-logo" /></a>
              ...
              <div className="af-class-section af-class-hero af-class-wf-section">
                <div className="af-class-container">
                  <div data-delay={4000} data-animation="fade" className="af-class-hero-slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit={0} data-nav-spacing={10} data-duration={1000} data-infinite="true">
                    <div className="w-slider-mask">
                      <div data-w-id="ec2afc2d-f943-794b-6c3e-3dc130fbfeed" className="w-slide">
                        <div className="af-class-hero-slider-content">
                          <div className="af-class-column af-class-hero-image-column">
                            <div className="af-class-hero-slider-image-wrap" />
                          </div>
                          <div id="w-node-f2bd7fdc-a738-1450-b4f9-1b53880bc1f6-58681516" style={{opacity: 0, WebkitTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-column af-class-max-600">
                            <h1 className="af-class-heading">Fracto </h1>
                            <h1 className="af-class-heading"><em>Democratizing NFTs</em></h1>
                            <p className="af-class-big-paragraph af-class-max-500">No longer are users restricted high cost entry, now with Fracto&nbsp;you can be a part of the generative art movement.</p>
                            <a href="about.html" className="af-class-button w-button">GET&nbsp;STARTED&nbsp;</a>
                          </div>
                        </div>
                      </div>
                      <div data-w-id="8e130818-647a-5ae2-c911-1131eabfb306" className="w-slide">
                        <div className="af-class-hero-slider-content">
                          <div className="af-class-column af-class-hero-image-column">
                            <h2 style={{WebkitTransform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', opacity: 0}} className="af-class-scribble-text af-class-slider-name">Get Moving</h2>
                            <div className="af-class-hero-slider-image-wrap"><img src="images/logan-weaver-RBbwGEKBbD8-unsplash.jpg" style={{WebkitTransform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', MozTransform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', msTransform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', transform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', filter: 'blur(5px)'}} sizes="(max-width: 767px) 95vw, 46vw" srcSet="images/logan-weaver-RBbwGEKBbD8-unsplash-p-500.jpeg 500w, images/logan-weaver-RBbwGEKBbD8-unsplash-p-800.jpeg 800w, images/logan-weaver-RBbwGEKBbD8-unsplash-p-1080.jpeg 1080w, images/logan-weaver-RBbwGEKBbD8-unsplash-p-1600.jpeg 1600w, images/logan-weaver-RBbwGEKBbD8-unsplash.jpg 1767w" alt className="af-class-hero-slider-image" /></div>
                          </div>
                          <div id="w-node-_8e130818-647a-5ae2-c911-1131eabfb30d-58681516" style={{opacity: 0, WebkitTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-column af-class-max-600">
                            <div className="af-class-label af-class-_15-margin">Make a change today<br /></div>
                            <h1>Premium online fitness classes &amp; nutrition.</h1>
                            <p className="af-class-big-paragraph af-class-max-500">I’ve created these premium fitness classes for everyone starting from beginner to advanced level with an in depth FAQ to answer all doubts.</p>
                            <a href="shop.html" className="af-class-button w-button">Premium classes</a>
                          </div>
                        </div>
                      </div>
                      <div data-w-id="b6ee397e-34f8-d374-0a5c-1ecf5c1e6307" className="w-slide">
                        <div className="af-class-hero-slider-content">
                          <div className="af-class-column af-class-hero-image-column">
                            <h2 style={{WebkitTransform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', opacity: 0}} className="af-class-scribble-text af-class-slider-name">free classes</h2>
                            <div className="af-class-hero-slider-image-wrap"><img src="images/logan-weaver-pD5kSwtNgMc-unsplash.jpg" style={{WebkitTransform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', MozTransform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', msTransform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', transform: 'translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(-10DEG) skew(0, 0)', filter: 'blur(5px)'}} sizes="(max-width: 767px) 95vw, 46vw" srcSet="images/logan-weaver-pD5kSwtNgMc-unsplash-p-500.jpeg 500w, images/logan-weaver-pD5kSwtNgMc-unsplash-p-800.jpeg 800w, images/logan-weaver-pD5kSwtNgMc-unsplash-p-1080.jpeg 1080w, images/logan-weaver-pD5kSwtNgMc-unsplash-p-1600.jpeg 1600w, images/logan-weaver-pD5kSwtNgMc-unsplash-p-2000.jpeg 2000w, images/logan-weaver-pD5kSwtNgMc-unsplash.jpg 2067w" alt className="af-class-hero-slider-image" /></div>
                          </div>
                          <div id="w-node-b6ee397e-34f8-d374-0a5c-1ecf5c1e630e-58681516" style={{opacity: 0, WebkitTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 100PX, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-column af-class-max-600">
                            <div className="af-class-label af-class-_15-margin">Make a change today<br /></div>
                            <h1>Transforming lifes with fitness &amp; nutrition.</h1>
                            <p className="af-class-big-paragraph af-class-max-500">With free online classes people who don’t have the time or money to afford a personal coach can make change their lives forever.</p>
                            <a href="free-workouts.html" className="af-class-button w-button">free classes</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="af-class-hero-nav-arrow af-class-left-arrow w-slider-arrow-left" />
                    <div className="af-class-hero-nav-arrow af-class-right-arrow w-slider-arrow-right" />
                    <div className="af-class-slide-nav w-slider-nav w-slider-nav-invert w-round" />
                  </div>
                </div>
              </div>
              <div className="af-class-section af-class-social-proof af-class-wf-section">
                <div className="af-class-container af-class-grid-3">
                  <div className="af-class-column af-class-flex-center">
                    <h4 className="af-class-_10-margin">Monthly users</h4>
                    <div className="af-class-label af-class-grey-label">1000+</div>
                  </div>
                  <div className="af-class-column af-class-flex-center">
                    <h4 className="af-class-_10-margin">Our Community</h4>
                    <div className="af-class-label af-class-grey-label">Over 200 Fracters</div>
                  </div>
                  <div className="af-class-column af-class-flex-center">
                    <h4 className="af-class-_10-margin">Network</h4>
                    <div className="af-class-label af-class-grey-label">endorsed by crypto websites</div>
                  </div>
                </div>
                <div className="af-class-blue-line af-class-bottom" />
                <div className="af-class-blue-line" />
              </div>
              <div data-w-id="704f228a-8df5-ffa9-c2aa-29c84ad7d262" className="af-class-section af-class-features af-class-wf-section">
                <div className="af-class-container af-class-features-grid">
                  <div id="w-node-_8d350ed8-e9a4-eb03-1dcf-82faec0a87df-58681516" className="af-class-column af-class-feature-headline">
                    <h2 className="af-class-max-800">Top Collections</h2>
                    <a href="about.html" className="af-class-button w-button">Trending now</a>
                  </div>
                  <div id="w-node-_1ac6e14c-5d80-b4fb-1311-8131a2fe412d-a2fe412d" className="af-class-column af-class-feature-column">
                    <div className="af-class-feature-img-and-graident">
                      <div className="af-class-feature-image-mask"><img src="images/Rectangle-439.png" alt className="af-class-feature-image" /></div>
                      <div className="af-class-feature-gradient" />
                    </div>
                    <h4 className="af-class-feature-max">1) title</h4>
                    <p className="af-class-max-400 af-class-no-margin">Description<br /></p>
                  </div>
                  <div id="w-node-_1ac6e14c-5d80-b4fb-1311-8131a2fe412d-a2fe412d" className="af-class-column af-class-feature-column">
                    <div className="af-class-feature-img-and-graident">
                      <div className="af-class-feature-image-mask"><img src="images/logan-weaver-24LpwagvuDY-unsplash.jpg" alt sizes="(max-width: 479px) 150px, 300px" srcSet="images/logan-weaver-24LpwagvuDY-unsplash-p-500.jpeg 500w, images/logan-weaver-24LpwagvuDY-unsplash-p-800.jpeg 800w, images/logan-weaver-24LpwagvuDY-unsplash-p-1080.jpeg 1080w, images/logan-weaver-24LpwagvuDY-unsplash.jpg 1581w" className="af-class-feature-image" /></div>
                      <div className="af-class-feature-gradient" />
                    </div>
                    <h4 className="af-class-feature-max">Understand how to do excercises properly</h4>
                    <p className="af-class-max-400 af-class-no-margin">Just going to the gym and lifting weights won't make you healthy, after all it may even cause some harm to your body. We teach proper exercise techniques</p>
                  </div>
                  <div id="w-node-_1ac6e14c-5d80-b4fb-1311-8131a2fe412d-a2fe412d" className="af-class-column af-class-feature-column">
                    <div className="af-class-feature-img-and-graident">
                      <div className="af-class-feature-image-mask"><img src="images/logan-weaver-Oyw8t2UTUWQ-unsplash.jpg" alt sizes="(max-width: 479px) 150px, 300px" srcSet="images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-500.jpeg 500w, images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-800.jpeg 800w, images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-1080.jpeg 1080w, images/logan-weaver-Oyw8t2UTUWQ-unsplash-p-1600.jpeg 1600w, images/logan-weaver-Oyw8t2UTUWQ-unsplash.jpg 1780w" className="af-class-feature-image" /></div>
                      <div className="af-class-feature-gradient" />
                    </div>
                    <h4 className="af-class-feature-max">Track your progress weekly</h4>
                    <p className="af-class-max-400 af-class-no-margin">We're tracking your goal weight with body fat measures, weight and general feeling. You may have the same body weight but feel 10x better.</p>
                  </div>
                  <div id="w-node-_1ac6e14c-5d80-b4fb-1311-8131a2fe412d-a2fe412d" className="af-class-column af-class-feature-column">
                    <div className="af-class-feature-img-and-graident">
                      <div className="af-class-feature-image-mask"><img src="images/Rectangle-441.png" alt className="af-class-feature-image" /></div>
                      <div className="af-class-feature-gradient" />
                    </div>
                    <h4 className="af-class-feature-max">Follow a specific plan made just for you</h4>
                    <p className="af-class-max-400 af-class-no-margin">Everyone is different, and we know it. That's why all of our clients get a programme specific just for their lifestyle and body tipe. This give the best possible results.</p>
                  </div>
                  <div className="af-class-arrow-nav"><img src="images/AArrow-1.svg" alt /></div>
                </div>
              </div>
              <div data-w-id="7fddf232-87f5-9178-f759-6162de48fac6" className="af-class-section af-class-free-classes af-class-wf-section">
                <div className="af-class-container af-class-free-plan-container">
                  <div className="af-class-column af-class-workouts-headline">
                    <h2 className="af-class-jumbo af-class-max-800">Resources</h2>
                    <p className="af-class-big-paragraph af-class-max-600">One step closer to being part of the revolutionary potential of NFTs</p>
                    <a href="free-workouts.html" className="af-class-button w-button">Start now</a>
                  </div>
                        ...
                        <a href="#" className="af-class-product-card w-inline-block">
                          ...
                          <div className="af-class-product-description">
                            ...
                            <div className="af-class-price-wrap">
                              <h6 className="af-class-scribble-text">Free</h6>
                            </div>
                            <div className="af-class-link">Start Now</div>
                          </div>
                        </a>
                      </div>
                    </div>
              ...
              <div data-w-id="c0ad97f2-2461-377f-0d16-9bb4ea129ed1" className="af-class-section af-class-premium-classes af-class-wf-section">
                <div className="af-class-container af-class-free-plan-container">
                  <div className="af-class-column af-class-workouts-headline">
                    <h2 className="af-class-jumbo af-class-max-800">About Fracto</h2>
                    <p className="af-class-big-paragraph af-class-max-600">Founded by university students in Austin, Texas, Fracto serves as an opportunity for users to buy and sell small shares of their NFT. Given that it is difficult for people to buy NFTs due to the high price point, Fracto helps level the playing field for all users by making NFT space more inclusive during this shift to digitization. </p>
                    <a href="shop.html" className="af-class-button af-class-white w-button">View all</a>
                  </div>
                  <div className="af-class-products-list-wrapper w-dyn-list">
                    <div role="list" className="af-class-product-list w-dyn-items">
                      <div role="listitem" className="af-class-product-item w-dyn-item">
              ...
              <div data-w-id="ededa43e-fca0-979f-fa07-c350e76c59dd" className="af-class-section af-class-photo-section af-class-wf-section">
                <div className="af-class-container">
                  <h2 className="af-class-scribble-text">SWEAT. GAIN. DO.</h2>
                </div><img src="images/Lines.svg" alt className="af-class-section-lines" /><img src="images/logan-weaver-WJUrYr5KqSw-unsplash-2.png" sizes="100vw" srcSet="images/logan-weaver-WJUrYr5KqSw-unsplash-2-p-500.png 500w, images/logan-weaver-WJUrYr5KqSw-unsplash-2-p-800.png 800w, images/logan-weaver-WJUrYr5KqSw-unsplash-2-p-1080.png 1080w, images/logan-weaver-WJUrYr5KqSw-unsplash-2.png 1440w" alt className="af-class-section-bg-image" />
              </div>
              <div data-w-id="4cb83808-f988-e8d9-cf74-c6011c7b007b" className="af-class-section af-class-call-section af-class-wf-section">
                <div className="af-class-container af-class-grid-2">
                  <div id="w-node-_48f1e152-304c-af08-bac2-2094cbc0c067-58681516" className="af-class-column af-class-description-heading">
                    <h2 className="af-class-max-600">Who can benefit from a fully custom online fitness plan and nutrition?</h2>
                    <p className="af-class-big-paragraph af-class-max-500">Literally everyone. I’m currently helping people from 12 to 60+ years old. Everyone is getting an adjusted program and a meal plan.</p>
                    <a href="contact.html" className="af-class-button w-button">Book a call</a>
                  </div>
                  <div id="w-node-d7b1a011-026b-afea-5499-7750c3a8ba54-58681516" className="af-class-description-image-wrap"><img src="images/Rectangle-441.png" alt className="af-class-description-image" /></div>
                </div>
                <div className="af-class-description-bg" />
              </div>
              ...
              <div data-w-id="6b468556-adf2-b53f-066f-f849d64c6523" className="af-class-section af-class-blog-section af-class-wf-section">
                <div className="af-class-container">
                  <div className="af-class-column af-class-feature-headline">
                    <h2>Read our tips and tricks</h2>
                    <p className="af-class-big-paragraph af-class-max-800">We post a lot of free content around health fitness and general wellbeing. Make sure to check all of our posts down below.</p>
                    <a href="blog.html" className="af-class-button w-button">view all posts</a>
                  </div>
                  <div className="af-class-blog-list-wrapper w-dyn-list">
                    <div role="list" className="af-class-blog-list w-dyn-items">
                      <div role="listitem" className="w-dyn-item">
                        <a href="#" className="af-class-blog-item w-inline-block">
                          <div className="af-class-blog-content">
                            <div className="af-class-author-sideflex">
                              <div className="af-class-author-image-mask"><img src alt className="af-class-author-image" /></div>
                              <div className="af-class-label af-class-small" />
                            </div>
                            <h5 />
                            <div className="af-class-link">Read more</div>
                            <div className="af-class-category-label" />
                          </div><img src alt className="af-class-blog-item-image" />
                        </a>
                      </div>
                    </div>
                    <div className="w-dyn-empty">
