...
class DetailFreePlansView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/DetailFreePlansController')
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = DetailFreePlansView
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe353368152c'
  ...
  render() {
    const proxies = DetailFreePlansView.Controller !== DetailFreePlansView ? transformProxies(this.props.children) : {
    ...
    return (
      <span>
        ...
        <span className="af-view">
          <div>
            <div className="af-class-page-wrap">
                ...
                <div className="af-class-container">
                  <div className="af-class-hero-slider-content">
                    <div className="af-class-column af-class-hero-image-column">
                      <div className="af-class-hero-slider-image-wrap"><img src alt className="af-class-hero-slider-image" /></div>
                    </div>
                    <div id="w-node-b904d0c6-89dd-4436-190e-a4c6cdc8fdc4-3368152c" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin" />
                      <h1 />
                      <p className="af-class-big-paragraph af-class-max-500" />
                      <div className="af-class-author-sideflex af-class-_30-px-margin">
                      ...
                      <a href="#Workout" className="af-class-button w-button">Start workout</a>
                    </div>
                  </div>
                </div>
              </div>
              <div id="Workout" data-w-id="b904d0c6-89dd-4436-190e-a4c6cdc8fdd1" className="af-class-section af-class-workout-content af-class-wf-section">
                <div className="af-class-container af-class-workout-container">
                  <div id="w-node-b904d0c6-89dd-4436-190e-a4c6cdc8fdd3-3368152c" className="af-class-column af-class-feature-headline">
                    <div className="w-richtext" />
                  </div>
                  <a href="#" className="af-class-about-video-wrap w-inline-block w-lightbox"><img src alt className="af-class-about-video-image" />
                    <div className="af-class-play-button-wrap"><img src="images/Play-Button.svg" alt className="af-class-play-button" /></div>
                  </a>
                </div>
                <div className="af-class-container af-class-aditional-workout">
                  <div className="w-richtext" />
                </div>
              </div>
              <div data-w-id="82132cc5-094e-04d8-bf08-ac350a8660df" className="af-class-section af-class-free-classes af-class-wf-section">
                <div className="af-class-container af-class-free-plan-container">
                  <div className="af-class-column af-class-workouts-headline">
                    <h2 className="af-class-jumbo af-class-max-800">More workouts you might like...</h2>
                  </div>
                      ...
                      <div role="listitem" className="af-class-product-item w-dyn-item">
                        <a href="#" className="af-class-product-card w-inline-block">
                          ...
                          <div className="af-class-product-description">
                            ...
                            <div className="af-class-link">Train now</div>
                          </div>
                        </a>
                      </div>
                    </div>
...
export default DetailFreePlansView
