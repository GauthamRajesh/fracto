...
class FreeWorkoutsView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/FreeWorkoutsController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe05eb681530'
  ...
  render() {
    const proxies = FreeWorkoutsView.Controller !== FreeWorkoutsView ? transformProxies(this.props.children) : {
            ...
            <div style={{opacity: 0}} className="af-class-page-wrap">
                ...
                <div className="af-class-container af-class-nav-container">
                  ...
                  <div className="af-class-nav-right-wrap">
                    <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                      ...
                      <a href="free-workouts.html" aria-current="page" className="af-class-nav-link w-nav-link w--current">Resources</a>
              ...
              <div className="af-class-section af-class-free-w-hero af-class-wf-section">
                <div className="af-class-container af-class-flex-center">
                  <div className="af-class-hero-image-mask"><img src="images/guillaume-bolduc-hdBaq9W0hRY-unsplash.jpg" srcSet="images/guillaume-bolduc-hdBaq9W0hRY-unsplash-p-500.jpeg 500w, images/guillaume-bolduc-hdBaq9W0hRY-unsplash-p-800.jpeg 800w, images/guillaume-bolduc-hdBaq9W0hRY-unsplash-p-1080.jpeg 1080w, images/guillaume-bolduc-hdBaq9W0hRY-unsplash-p-1600.jpeg 1600w, images/guillaume-bolduc-hdBaq9W0hRY-unsplash-p-2000.jpeg 2000w, images/guillaume-bolduc-hdBaq9W0hRY-unsplash.jpg 2255w" sizes="95vw" alt className="af-class-hero-image" /><img src="images/Group-117.svg" alt className="af-class-free-workout-shape" /></div>
                  <div className="af-class-hero-line">
                    <h1 className="af-class-no-margin">Free home workouts</h1>
                  </div>
                </div>
              ...
              <div className="af-class-section af-class-footer-section af-class-wf-section">
                <div className="af-class-container af-class-footer-container">
                  ...
                  <div id="w-node-_1d6466da-e94d-115c-c97d-71e22c54b46f-2c54b452" className="af-class-column">
                    ...
                    <a href="free-workouts.html" aria-current="page" className="af-class-footer-link w--current">Free Courses</a>
...
export default FreeWorkoutsView
