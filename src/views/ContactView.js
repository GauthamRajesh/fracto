...
class ContactView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe0623681528'
        ...
        <span className="af-view">
          <div>
            <div style={{opacity: 0}} className="af-class-page-wrap">
                ...
                <div className="af-class-container af-class-nav-container">
                  ...
                  <div className="af-class-nav-right-wrap">
                    <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                      ...
                      <a href="contact.html" aria-current="page" className="af-class-button af-class-small w-button w--current">Explore</a>
                    </nav>
              ...
              <div className="af-class-section af-class-contact-hero af-class-wf-section">
                <div className="af-class-container">
                  <div className="af-class-hero-slider-content">
                    <div id="w-node-f2bd7fdc-a738-1450-b4f9-1b53880bc1f6-23681528" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin">Contact<br /></div>
                      <h1>Get in touch today to schedule your discovery call.</h1>
                      <p className="af-class-big-paragraph af-class-max-500">Just fill out this short form on the right to get started in your life changing journey. If you prefer you can contact us below directly.</p>
                      <div className="af-class-label af-class-_15-margin">Email</div>
                      <a href="#" className="af-class-contact-link">contact@fitnesso.com</a>
                      <div className="af-class-_30px-spacer" />
                      <div className="af-class-label af-class-_15-margin">Phone</div>
                      <a href="#" className="af-class-contact-link">+381 73 49 032</a>
                    </div>
                    <div id="w-node-aa2731c4-ac7b-fa72-caa7-5b2b0a16254a-23681528" className="af-class-contact-form w-form">
                      <form id="email-form" name="email-form" data-name="Email Form" method="get" className="af-class-form-content">
                        <div className="af-class-contact-form-grid"><input type="text" className="af-class-form-field w-input" maxLength={256} name="Full-Name" data-name="Full Name" placeholder="Full Name" id="Full-Name-3" required /><input type="text" className="af-class-form-field w-input" maxLength={256} name="Current-Weight" data-name="Current Weight" placeholder="Current Weight" id="Current-Weight" required /><input type="text" className="af-class-form-field w-input" maxLength={256} name="Goal-Weight" data-name="Goal Weight" placeholder="Goal Weight" id="Goal-Weight" required /><input type="email" className="af-class-form-field w-input" maxLength={256} name="Email" data-name="Email" placeholder="Email" id="Email" required /><textarea placeholder="Describe Your Goals" maxLength={5000} id="Describe-Your-Goals" name="Describe-Your-Goals" data-name="Describe Your Goals" className="af-class-text-area w-node-_8c6a0f55-9940-658b-7324-98313b6aa3d7-23681528 w-input" defaultValue={""} /><input type="submit" defaultValue="Get in touch" data-wait="Please wait..." id="w-node-aa2731c4-ac7b-fa72-caa7-5b2b0a162553-23681528" className="af-class-button w-button" /></div>
                      </form>
