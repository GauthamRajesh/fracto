...
class DetailProductView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe0af568152e'
        ...
        <span className="af-view">
          <div>
            <div className="af-class-page-wrap">
              ...
              <div className="af-class-section af-class-product-hero af-class-wf-section">
                <div className="af-class-container">
                  <div className="af-class-hero-slider-content">
                    <div id="w-node-_49560afd-8e03-a254-d6cb-d71c46b1fada-f568152e" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin" />
                      <h1 />
                      <p className="af-class-big-paragraph af-class-max-500" />
                      <div className="af-class-add-to-cart">
                        <form data-node-type="commerce-add-to-cart-form" className="w-commerce-commerceaddtocartform af-class-add-to-cart-sideflex"><input type="number" pattern="^[0-9]+$" inputMode="numeric" id="quantity-91e5900d66b94f1967eb37d9206b33ef" name="commerce-add-to-cart-quantity-input" min={1} className="w-commerce-commerceaddtocartquantityinput af-class-cart-quantity-2" defaultValue={1} /><input type="submit" id="w-node-_47c38c83-357c-c939-27c5-0fba8102f039-f568152e" data-node-type="commerce-add-to-cart-button" data-loading-text="Adding to cart..." defaultValue="Add to Cart" className="w-commerce-commerceaddtocartbutton af-class-button" />
                          <a id="w-node-_47c38c83-357c-c939-27c5-0fba8102f03a-f568152e" data-node-type="commerce-buy-now-button" data-default-text="Buy now" data-subscription-text="Subscribe now" className="w-commerce-commercebuynowbutton af-class-button" href="checkout.html">Buy now</a>
                        </form>
