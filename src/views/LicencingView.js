...
class LicencingView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/LicencingController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe1a7a681531'
  ...
  render() {
    const proxies = LicencingView.Controller !== LicencingView ? transformProxies(this.props.children) : {
          ...
          <div>
            <div style={{opacity: 0}} className="af-class-page-wrap">
              ...
              <div className="af-class-section af-class-about-hero af-class-wf-section">
                <div className="af-class-container af-class-licence-container">
                  <div className="af-class-hero-slider-content">
                    <div id="w-node-f2bd7fdc-a738-1450-b4f9-1b53880bc1f6-7a681531" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin">Unsplash<br /></div>
                      <h1>All photos in the template are from Unsplash</h1>
                      <div className="af-class-two-buttons">
                        <a href="https://unsplash.com/" target="_blank" className="af-class-button w-button">Visit site</a>
                        <a href="https://unsplash.com/license" target="_blank" className="af-class-button af-class-green w-button">Licence</a>
                      </div>
                    </div>
                ...
                <div className="af-class-container af-class-licence-container">
                  <div className="af-class-hero-slider-content">
                    <div className="af-class-column af-class-hero-image-column">
                      <div className="af-class-hero-slider-image-wrap"><img src="images/Fonts-Image.png" srcSet="images/Fonts-Image-p-500.png 500w, images/Fonts-Image-p-800.png 800w, images/Fonts-Image-p-1080.png 1080w, images/Fonts-Image-p-1600.png 1600w, images/Fonts-Image.png 2620w" sizes="(max-width: 767px) 95vw, (max-width: 991px) 46vw, 45vw" alt className="af-class-hero-slider-image" /></div>
                    </div>
                    <div id="w-node-_2f948e82-26d6-2d8c-c7c2-ae300fc89c01-7a681531" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin">Fonts licence<br /></div>
                      <h2>Fonts are licenced under Open Font Licence</h2>
                      <div className="af-class-two-buttons">
                        <a href="https://fontlot.com/141969/sato-sans-serif-font/" target="_blank" className="af-class-button w-button">Sato sans</a>
                        <a href="https://fonts.google.com/specimen/Red+Hat+Display" target="_blank" className="af-class-button w-button">Red hat Display</a>
                        <a href="https://fonts.google.com/specimen/Permanent+Marker" target="_blank" className="af-class-button w-button">Permanent Marker<br /></a>
                        <a href="https://en.wikipedia.org/wiki/SIL_Open_Font_License" target="_blank" className="af-class-button af-class-green w-button">OFL&nbsp;Licence</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="af-class-container af-class-licence-container">
                  <div className="af-class-hero-slider-content">
                    <div id="w-node-_4850ff83-be02-56a1-6fa5-3a92281e511c-7a681531" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin">Template design<br /></div>
                      <h1>Brought to you by Flow Ninja. Your go to Webflow Partner.</h1>
                      <div className="af-class-two-buttons">
                        <a href="https://www.flow.ninja/" target="_blank" className="af-class-button w-button">Visit site</a>
                      </div>
                    </div>
                    <div className="af-class-column af-class-hero-image-column">
                      <div className="af-class-hero-slider-image-wrap"><img src="images/5e6231134527705a3046043e_Home.png" srcSet="images/5e6231134527705a3046043e_Home-p-500.png 500w, images/5e6231134527705a3046043e_Home-p-800.png 800w, images/5e6231134527705a3046043e_Home-p-1080.png 1080w, images/5e6231134527705a3046043e_Home-p-1600.png 1600w, images/5e6231134527705a3046043e_Home.png 2400w" sizes="(max-width: 767px) 95vw, (max-width: 991px) 46vw, 45vw" alt className="af-class-hero-slider-image" /></div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="af-class-section af-class-footer-section af-class-wf-section">
                <div className="af-class-container af-class-footer-container">
                  ...
                  <div id="w-node-_1d6466da-e94d-115c-c97d-71e22c54b461-2c54b452" className="af-class-column">
                    ...
                    <a href="licencing.html" aria-current="page" className="af-class-footer-link w--current">Licencing</a>
