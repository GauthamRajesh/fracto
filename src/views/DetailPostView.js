...
class DetailPostView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe316a68152d'
  ...
  render() {
    const proxies = DetailPostView.Controller !== DetailPostView ? transformProxies(this.props.children) : {
            ...
            <div style={{opacity: 0}} className="af-class-page-wrap">
              ...
              <div className="af-class-section af-class-free-w-hero af-class-wf-section">
                <div className="af-class-container af-class-flex-center">
                  <div className="af-class-blog-item">
                    <div className="af-class-blog-content af-class-post-content">
                ...
                <div className="af-class-container af-class-blog-content-container">
