...
class DetailAuthorView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/DetailAuthorController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe1622681529'
  ...
  render() {
    const proxies = DetailAuthorView.Controller !== DetailAuthorView ? transformProxies(this.props.children) : {
        ...
        <span className="af-view">
          <div>
            <div className="af-class-page-wrap">
              ...
              <div className="af-class-section af-class-author-hero af-class-wf-section">
                <div className="af-class-container">
                  <div className="af-class-hero-slider-content">
                    <div id="w-node-ad7cd10b-54e4-9901-ddfb-577386584269-22681529" className="af-class-column af-class-max-600">
                      <div className="af-class-label af-class-_30-margin">Author</div>
                      <h1 />
                      <div className="w-richtext" />
                      <a href="#" className="af-class-button w-button" />
                    </div>
                    <div id="w-node-ad7cd10b-54e4-9901-ddfb-577386584273-22681529" className="af-class-column af-class-author-column">
                      <div className="af-class-hero-slider-image-wrap"><img src alt className="af-class-hero-slider-image" />
                        <div className="af-class-social-links-wrap">
                          <a href="#" className="af-class-social-links w-inline-block"><img src="images/003-twitter-logo-button.svg" alt className="af-class-social-icon af-class-author-links" /></a>
                          <a href="#" className="af-class-social-links w-inline-block"><img src="images/instagram.svg" alt className="af-class-social-icon af-class-author-links" /></a>
                          <a href="#" className="af-class-social-links w-inline-block"><img src="images/001-facebook-logo-button.svg" alt className="af-class-social-icon af-class-author-links" /></a>
                          <a href="#" className="af-class-social-links w-inline-block"><img src="images/youtube.svg" alt className="af-class-social-icon af-class-author-links" /></a>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default DetailAuthorView
