...
class DetailBlogCategoriesView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/DetailBlogCategoriesController')
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = DetailBlogCategoriesView
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '623f3e31626cbe0fc268152a'
  ...
  render() {
    const proxies = DetailBlogCategoriesView.Controller !== DetailBlogCategoriesView ? transformProxies(this.props.children) : {
            ...
            <div style={{opacity: 0}} className="af-class-page-wrap">
              ...
              <div className="af-class-section af-class-free-w-hero af-class-wf-section">
                <div className="af-class-container af-class-flex-center">
                  <div className="af-class-hero-image-mask"><img src="images/bruno-nascimento-PHIgYUGQPvU-unsplash.jpg" srcSet="images/bruno-nascimento-PHIgYUGQPvU-unsplash-p-500.jpeg 500w, images/bruno-nascimento-PHIgYUGQPvU-unsplash-p-800.jpeg 800w, images/bruno-nascimento-PHIgYUGQPvU-unsplash-p-1080.jpeg 1080w, images/bruno-nascimento-PHIgYUGQPvU-unsplash-p-1600.jpeg 1600w, images/bruno-nascimento-PHIgYUGQPvU-unsplash-p-2000.jpeg 2000w, images/bruno-nascimento-PHIgYUGQPvU-unsplash.jpg 2010w" sizes="95vw" alt className="af-class-hero-image" /><img src="images/Group-117.svg" alt className="af-class-free-workout-shape" /></div>
                  <div className="af-class-hero-line af-class-blog-line">
                    <h1 className="af-class-no-margin" />
                  </div>
                </div>
                <div className="af-class-container af-class-blog-container">
                  <div className="af-class-blog-categories">
                    ...
                    <div className="af-class-categories-sideflex">
                      <a href="blog.html" className="af-class-button af-class-categories-button w-button">All</a>
...
export default DetailBlogCategoriesView
